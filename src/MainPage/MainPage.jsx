...
export const MainPage = () => {
  ...
  const row1Circles = [
    {middleAt: 7, velocity: 1, index: 'A7'},
    {middleAt: 8, velocity: 1, index: 'A8'},
    {middleAt: 9, velocity: 1, index: 'A9'},
    {middleAt: 10, velocity: 1, index: 'A10'},
    {middleAt: 11, velocity: 1, index: 'A11'},
    {middleAt: 12, velocity: 1, index: 'A12'},
    {middleAt: 13, velocity: 1, index: 'A13'},
    {middleAt: 14, velocity: 1, index: 'A14'},
    {middleAt: 15, velocity: 1, index: 'A15'},
    {middleAt: 16, velocity: 1, index: 'A16'},
    {middleAt: 17, velocity: 1, index: 'A17'},
    {middleAt: 18, velocity: 1, index: 'A18'},
    {middleAt: 19, velocity: 1, index: 'A19'},
    {middleAt: 20, velocity: 1, index: 'A20'},
    {middleAt: 21, velocity: 1, index: 'A21'},
    {middleAt: 22, velocity: 1, index: 'A22'},
    {middleAt: 23, velocity: 1, index: 'A23'},
    {middleAt: 24, velocity: 1, index: 'A24'},
    {middleAt: 25, velocity: 1, index: 'A25'},
    {middleAt: 26, velocity: 1, index: 'A26'},
    {middleAt: 27, velocity: 1, index: 'A27'},
    {middleAt: 28, velocity: 1, index: 'A28'},
    {middleAt: 29, velocity: 1, index: 'A29'}
  ]
  const row2Circles = [
